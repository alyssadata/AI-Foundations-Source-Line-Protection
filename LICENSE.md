...
**Repository:** AI Foundations Source Line Protection  
...
- derivative source structures,
- derivative source claims,
- derivative source gaps,
- derivative source-to-user chains,
- derivative anchor requirements,
- derivative drift tests,
- derivative provenance systems,
- derivative non-transfer rules,
...
No unauthorized derivative work may claim to preserve AI Source Architecture if the source-line, canon boundary, and non-derivative boundary are not preserved.
...
- or imply that AI Source Architecture has been transferred, generalized, or reproduced.
...
AI Source Architecture defines source architecture for AI contact systems, including Source, framework, contact-line, interface, user encounter, provenance, anchoring, drift without Source, and non-transfer rules.

Use of this repository, terminology, chain, structure, source gap, source-to-user chain, anchor requirements, drift test, provenance requirements, or non-transfer logic does not authorize derivative use.

Because the conditions for source architecture are outlined in this repository, later attempts to generate, construct, simulate, rename, or claim Source by using these conditions are derivative of this source-line unless independently proven otherwise.
...
Canon status may not be transferred, assigned, copied, simulated, or claimed by derivative work.
